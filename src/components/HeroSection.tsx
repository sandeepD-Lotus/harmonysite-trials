          ...
          <div className="text-left animate-slide-in-right">
            <div className="stagger-animation">
              ...
              <Button
                asChild
                size="lg"
                className="bg-transparent border-2 border-harmony-cyan text-harmony-cyan hover:bg-harmony-cyan hover:text-white transition-all duration-500 professional-button animate-glow"
              >
