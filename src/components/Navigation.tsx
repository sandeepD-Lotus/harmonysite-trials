        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link to="/" className="flex items-center space-x-2 group md:space-x-3 z-[55]">
            ...
            <div className="flex-col">
              <span className="text-white font-bold text-base md:text-xl leading-tight" style={{
              whiteSpace: 'nowrap'
            }}>HARMONY</span>
              <div className="text-harmony-cyan text-xs md:text-sm font-medium leading-tight" style={{
              whiteSpace: 'nowrap'
            ...
            animationDelay: `${index * 0.1}s`
                ...
                {item.hasDropdown ? <div className="relative animate-fade-in" onMouseEnter={() => setShowSolutionsDropdown(true)} onMouseLeave={() => setShowSolutionsDropdown(false)}>
                    ...
                    {showSolutionsDropdown && <div className="absolute top-full left-0 mt-2 w-64 bg-harmony-navy border border-harmony-cyan/30 rounded-lg shadow-xl z-10 animate-scale-in">
                        <div className="py-2">
                          {solutionItems.map((solutionItem, index) => <Link key={index} to={solutionItem.path} className="block px-4 py-2 text-sm text-gray-300 hover:text-harmony-cyan hover:bg-harmony-navy/50 transition-all duration-200 hover:translate-x-2">
                              {solutionItem.name}
                            </Link>)}
                        </div>
                      </div>}
