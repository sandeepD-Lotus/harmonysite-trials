          ...
          <div className="hidden md:flex flex-1 items-center justify-center space-x-8 min-w-0 overflow-x-auto">
            {navItems.map((item, index) => (
              <div key={item.name} className="relative" style={{ animationDelay: `${index * 0.1}s` }}>
                {item.hasDropdown ? (
                  <div className="relative animate-fade-in" onMouseEnter={() => setShowSolutionsDropdown(true)} onMouseLeave={() => setShowSolutionsDropdown(false)}>
                      ...
                      <div className="absolute top-full left-0 mt-2 w-64 bg-harmony-navy border border-harmony-cyan/30 rounded-lg shadow-xl z-10 animate-scale-in">
                        <div className="py-2">
                          {solutionItems.map((solutionItem, idx) => (
                            <Link key={idx} to={solutionItem.path} className="block px-4 py-2 text-sm text-gray-300 hover:text-harmony-cyan hover:bg-harmony-navy/50 transition-all duration-200 hover:translate-x-2">
                              {solutionItem.name}
                            </Link>
                          ))}
                        </div>
            ...
            <div className="flex justify-between items-start px-4 pb-1 w-full bg-harmony-navy z-10">
              ...
              <Link to="/" className="flex items-center space-x-2 group">
                ...
                <div className="flex-col ml-2">
                  ...
                  <div className="text-harmony-cyan text-[0.6rem] font-medium leading-tight" style={{ whiteSpace: 'nowrap' }}>
